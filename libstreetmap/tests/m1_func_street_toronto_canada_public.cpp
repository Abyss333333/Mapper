...
SUITE(street_queries_public_toronto_canada) {
    ...
    TEST_FIXTURE(MapFixture, street_names) {
    ...
    bool z=true;
        ...
        temp = find_street_ids_from_name("Ramp to Highway 404 Northbound");
        
        for (unsigned i=0; i<temp.size(); i++ ){
            std::string name = getStreetName(temp[i]);
            z= (name=="Ramp to Highway 404 Northbound");
            if(!z)
                break;
        ...
        temp = find_street_ids_from_name("Little Hannah Lane");
        
        for (unsigned i=0; i<temp.size(); i++ ){
            std::string name = getStreetName(temp[i]);
            z= (name=="Little Hannah Lane");
                if(!z)
                    break;
        ...
        temp = find_street_ids_from_name("Barberry Lane");
        
        for (unsigned i=0; i<temp.size(); i++ ){
            std::string name = getStreetName(temp[i]);
            z= (name=="Barberry Lane");
                if(!z)
                    break;
        ...
        temp = find_street_ids_from_name("Ardmore Crescent");
        
        for (unsigned i=0; i<temp.size(); i++ ){
            std::string name = getStreetName(temp[i]);
            z= (name=="Ardmore Crescent");
               if(!z)
                break;
        ...
        temp = find_street_ids_from_name("Mojave Crescent");
        
        for (unsigned i=0; i<temp.size(); i++ ){
            std::string name = getStreetName(temp[i]);
            z=(name=="Mojave Crescent");
                if(!z)
                break;
        ...
        temp = find_street_ids_from_name("Forest Glen Crescent");
        
        for (unsigned i=0; i<temp.size(); i++ ){
            std::string name = getStreetName(temp[i]);
            z= (name=="Forest Glen Crescent");
                if(!z)
                break;
        ...
        temp = find_street_ids_from_name("Blue Beech Crescent");
       
        for (unsigned i=0; i<temp.size(); i++ ){
            std::string name = getStreetName(temp[i]);
            z= (name=="Blue Beech Crescent");
                if(!z)
                break;
        ...
        temp = find_street_ids_from_name("Ten Oaks Boulevard");
        
        for (unsigned i=0; i<temp.size(); i++ ){
            std::string name = getStreetName(temp[i]);
            z= (name=="Ten Oaks Boulevard");
                if(!z)
                break;
